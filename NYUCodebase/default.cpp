...
void playerControls(Entity player, bool shot, int clip, std::vector<Entity> bullets);
...
void UpdateScore(int num){
    ...
    DrawText(LoadTexture("font1.png"), numDis, 0.1, 0.000000000001, 1.0, 1.0, 1.0, 1.0);
}
